    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md shadow-lg border-none">
        <CardHeader className="space-y-1 text-center">
          ...
          <div className="bg-emerald-100 text-emerald-800 text-[10px] font-bold py-1 px-2 rounded-full inline-block mt-2 uppercase">
            STABLE VERSION: 20-02-2026 (10:30) - Excel Data Synced
          </div>
          <CardDescription>
